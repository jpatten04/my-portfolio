export const ProjectList = [
	{
		...
		imgUrls: [
			"/src/assets/images/movie-recommender/search.png",
			"/src/assets/images/movie-recommender/details.png",
			"/src/assets/images/movie-recommender/recommendations.png",
		],
		description:
	...
	},
	{
		...
		imgUrls: [
			"/src/assets/images/futures-trading-journal/stats.png",
			"/src/assets/images/futures-trading-journal/calendar.png",
		],
		description:
	...
	},
	{
		...
		imgUrls: ["/src/assets/images/pixel-art-canvas/canvas.png"],
		description:
